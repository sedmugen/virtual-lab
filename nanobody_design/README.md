...
After following the general `virtual_lab` installation [instructions](https://github.com/sedmugen/virtual-lab/blob/main/README.md), run the following to install nanobody-specific requirements:
